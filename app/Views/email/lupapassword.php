                                ...
                                <table width="100%" cellpadding="0" cellspacing="0">
                                    ...
                                    <tr>
                                        <td class="content-block">
                                            Kamu baru saja mengajukan permintaan setel ulang kata sandi. Kami akan membantu untuk menyetel ulang kata sandi kamu. <br>
                                    ...
                                    <tr>
                                        <td class="content-block">
                                            <div style="color: #999;">Jika tombol diatas tidak berfungsi, kamu bisa klik link dibawah ini atau copy paste pada browser</div><br>
                                            <?php echo base_url('reset-password?email=' . $email . '&token=' . urlencode($token)) ?>
                                        </td>
                                    </tr>
                                    <tr>
